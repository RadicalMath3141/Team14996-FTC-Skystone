...
public class SampleMecanumDrive extends MecanumDrive implements Subsystem {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(0.5, 0, 0.1);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(0.5, 0, 0.1);
    ...
    private static SampleMecanumDrive sampleMecanumDrive;
...
//        dashboard.setTelemetryTransmissionInterval(25);
    ...
    public static SampleMecanumDrive getInstance(HardwareMap hardwareMap){
        if(sampleMecanumDrive == null){
            sampleMecanumDrive = new SampleMecanumDrive(hardwareMap);
        }
        return sampleMecanumDrive;
    }
    ...
    public TrajectoryBuilder trajectoryBuilderReversed(){
        return new TrajectoryBuilder(new Pose2d(getPoseEstimate().getX(),getPoseEstimate().getY(), Angle.norm(getPoseEstimate().getHeading() + Math.PI)), true, constraints);
    }
